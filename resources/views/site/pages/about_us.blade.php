            ...
            <div class="about-content">
                ...
                <div class="about-text animate__animated animate__fadeInLeft">
                    <p class="about-description">
                        توکا پت شاپ در سال ۱۳۹۰ با هدف ارائه بهترین محصولات و خدمات برای حیوانات خانگی تأسیس شد. ما باور
                        داریم که حیوانات خانگی عضو مهمی از خانواده هستند و شایسته بهترین مراقبت و توجه می‌باشند.
                    </p>
                    <p class="about-description">
                        تیم متخصص ما متشکل از دامپزشکان، متخصصین تغذیه و مربیان حیوانات است که همگی عاشق حیوانات هستند و
                        دانش خود را به صورت مستمر به روز می‌کنند. ما تنها ارائه‌دهنده محصولات نیستیم، بلکه مشاور شما در
                        زمینه نگهداری، تربیت و سلامت حیوانات خانگی هستیم.
                    </p>
                    <p class="about-description">
                        محصولات ما با دقت و وسواس زیاد انتخاب شده‌اند و تنها برندهای معتبر و باکیفیت را ارائه می‌دهیم. از
                        غذای حیوانات گرفته تا اسباب‌بازی، وسایل نگهداری و محصولات بهداشتی، همه و همه با استانداردهای بالا
                        مطابقت دارند.
                    </p>
